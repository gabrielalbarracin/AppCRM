...
import CompCreatePedidoLogistica from './CreatePedidoLogistica'
...
const DataTableCrudDemo = () => {
    ...
    const header = (
        <div className="tabla table-header">
            ...
            <h5 className="productosfres mx-0 my-1">Productos logistica</h5>
    ...
    return (
        <div className="datatable-crud-demo">
            ...
            <CompCreatePedidoLogistica show={show} handleClose={handleClose}/>
        </div> 
    );
}
